      ...
      <div className="relative z-10 container mx-auto px-4 py-20">
                ...
                <div className="relative">
                  <label className="flex flex-col items-center justify-center w-full p-4 border-2 border-dashed border-zinc-700/50 rounded-lg bg-zinc-800/50 hover:bg-zinc-800/70 transition-all cursor-pointer">
                    <div className="flex flex-col items-center justify-center">
                      <svg
                        className="w-8 h-8 mb-3 text-zinc-500"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
        ...
        {agents?.data?.length === 0 ? (
          <div className="bg-zinc-800/50 backdrop-blur-lg rounded-xl border border-zinc-700/50 p-12 text-center max-w-2xl mx-auto">
            ...
            <h3 className="text-2xl font-medium text-zinc-200 mb-2">
              No Agents Found
            </h3>
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            {agents?.data?.map((agent, index) => (
              ...
              >
                {/* Card glow effect */}
                <div
                  className={`absolute inset-0 bg-gradient-to-br from-cyan-500/10 to-purple-500/10 rounded-xl transition-all duration-500 ${
                  ...
                  <div className="relative h-48 overflow-hidden">
                    {agent.image ? (
                      ...
                      <div className="w-full h-full bg-gradient-to-br from-zinc-700 to-zinc-800 flex items-center justify-center">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          className="h-16 w-16 text-cyan-400/30"
                          fill="none"
                          viewBox="0 0 24 24"
                          stroke="currentColor"
                        >
                  ...
                  <div className="p-6 flex-grow flex flex-col">
                    ...
                    <div className="mt-auto space-y-3">
                      <div className="flex items-start">
                        ...
                        <span className="text-zinc-400 ml-2 break-all">
                          {agent?.email}
                        </span>
                      </div>
